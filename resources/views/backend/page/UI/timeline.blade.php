                            ...
                            <div class="timeline"> <!-- timeline time label -->
                                ...
                                <div> <i class="timeline-icon bi bi-camera text-bg-primary"></i>
                                    <div class="timeline-item"> <span class="time"> <i class="bi bi-clock-fill"></i> 2 days ago
                                        ...
                                        <div class="timeline-body"> <img src="../../../dist/assets/img/user1-128x128.jpg" alt="..."> <img src="../../../dist/assets/img/user1-128x128.jpg" alt="..."> <img src="../../../dist/assets/img/user1-128x128.jpg" alt="..."> <img src="../../../dist/assets/img/user1-128x128.jpg" alt="..."> </div>
                                    </div>
                                </div> <!-- END timeline item --> <!-- timeline item -->
