                                ...
                                <div class="card-body"> <!-- Conversations are loaded here -->
                                    <div class="direct-chat-messages"> <!-- Message. Default to the start -->
                                        <div class="direct-chat-msg">
                                            <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-start">
                                                    ...
                                                    23 Jan 2:00 pm
                                                </span> </div> <!-- /.direct-chat-infos --> <img class="direct-chat-img" src="{{asset('backend/dist/assets/img/user1-128x128.jpg')}}" alt="message user image"> <!-- /.direct-chat-img -->
                                        ...
                                        <div class="direct-chat-msg end">
                                            <div class="direct-chat-infos clearfix"> <span class="direct-chat-name float-end">
                                                    ...
                                                    23 Jan 2:05 pm
                                                </span> </div> <!-- /.direct-chat-infos --> <img class="direct-chat-img" src="{{asset('backend/dist/assets/img/user3-128x128.jpg')}}" alt="message user image"> <!-- /.direct-chat-img -->
                                            <div class="direct-chat-text">
                                    ...
                                    <div class="direct-chat-contacts">
                                        <ul class="contacts-list">
                                            <li> <a href="#"> <img class="contacts-list-img" src="{{asset('backend/dist/assets/img/user1-128x128.jpg')}}" alt="User Avatar">
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img" src="{{asset('backend/dist/assets/img/user7-128x128.jpg')}}" alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            Sarah Doe
                                                            <small class="contacts-list-date float-end">
                                                                2/23/2023
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img" src="{{asset('backend/dist/assets/img/user3-128x128.jpg')}}" alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            Nadia Jolie
                                                            <small class="contacts-list-date float-end">
                                                                2/20/2023
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img" src="{{asset('backend/dist/assets/img/user5-128x128.jpg')}}" alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            Nora S. Vans
                                                            <small class="contacts-list-date float-end">
                                                                2/10/2023
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img" src="{{asset('backend/dist/assets/img/user6-128x128.jpg')}}" alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            John K.
                                                            <small class="contacts-list-date float-end">
                                                                1/27/2023
                                            ...
                                            <li> <a href="#"> <img class="contacts-list-img" src="{{asset('backend/dist/assets/img/user8-128x128.jpg')}}" alt="User Avatar">
                                                    <div class="contacts-list-info"> <span class="contacts-list-name">
                                                            Kenneth M.
                                                            <small class="contacts-list-date float-end">
                                                                1/4/2023
