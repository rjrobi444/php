	...
	<head>
		...
		<body>
				...
				<div class="container">
					<div class="row justify-content-center align-items-center ">
						...
						<div class="col-lg-6 video-right justify-content-center align-items-center d-flex">
							...
							<a class="play-btn" href="https://www.youtube.com/watch?v=ARA0AxrnHdM"><img class="img-fluid" src="{{asset('frontend/img/play-icon.png')}}" alt=""></a>
						</div>
					</div>
				</div>
			</section>
				...
				<div class="container">
					...
					<div class="row justify-content-center align-items-center">
						...
						<div class="col-lg-6 course-middle">
							<img class="mx-auto img-fluid d-block" src="{{asset('frontend/img/c1.png')}}" alt="">
						</div>
			...
			<section class="service-area section-gap" id="service">
				<div class="container">
					<div class="row d-flex justify-content-center">
						<div class="pb-40 col-md-8 header-text">
					...
					<div class="row">
						<div class="col-lg-3 col-md-6">
							<div class="single-unique-product">
								<img class="img-fluid" src="{{asset('frontend/img/u1.jpg')}}" alt="">
								<div class="desc">
									<h4>
										Apple Watch White
									</h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-unique-product">
								<img class="img-fluid" src="{{asset('frontend/img/u2.jpg')}}" alt="">
								<div class="desc">
									<h4>
										Apple Watch White
									</h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-unique-product">
								<img class="img-fluid" src="{{asset('frontend/img/u3.jpg')}}" alt="">
								<div class="desc">
									<h4>
										Apple Watch White
									</h4>
						...
						<div class="col-lg-3 col-md-6">
							<div class="single-unique-product">
								<img class="img-fluid" src="{{asset('frontend/img/u4.jpg')}}" alt="">
								<div class="desc">
									<h4>
										Apple Watch White
									</h4>
